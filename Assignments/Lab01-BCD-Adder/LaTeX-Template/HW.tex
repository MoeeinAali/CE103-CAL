...
\toprule
{نمونه} & {بیت} & {ورودی} \lr{A} & {ورودی} \lr{B} & \lr{Cin} & {جمع نهایی} & {رقم نقلی} \\
\midrule
...
{چرا رقم نقلی \lr{FAC3} استفاده نمی‌شود؟}
...
\toprule
{نمونه} & {رقم} & \lr{A} & \lr{B} & \lr{Cin} & \lr{Cout} می‌رود به \\
\midrule
...
بردارهای تست داخل فایل‌های \lr{*.vec} قرار دارند.
